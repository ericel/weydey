    ...
    <div style="margin-top: 50px" class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-primary" >
            ...
            <div class="panel-body">
                ...
                <small id="realname1">Hint:The Name and Surname field is not a valid name. "John Doe"</small>
                ...
                <div class="form-group">
                <small id="username1">Hint:The Username must be at least 6 characters. "Johndoe"</small>
                    <p><input type="text" name="username" id="username" onblur="checkusername()" class="form-control input-lg col-xs-12 col-sm-12 col-md-12" placeholder="<?= __d('system', 'Username'); ?>" onkeyup="restrict('username')"><br><br></p>
                </div>
                <div class="form-group">
                    <small id="password1">Hint:Password must contain one uppercase character and a number: "MypassWord123"</small>
                ...
                <div class="form-group">
                  <small id="email1"></small>
                    <p><input type="text" name="email" id="email" class="form-control input-lg col-xs-12 col-sm-12 col-md-12" onkeyup="restrict('email')" placeholder="<?= __d('system', 'E-Mail'); ?>"><br><br></p>
                </div>
                <hr>
