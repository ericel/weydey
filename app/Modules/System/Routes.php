...
Route::post('register/checkusername',                 array('before' => 'guest', 'uses' => 'Registrar@checkUsername'));
...
Route::group(array('prefix' => 'admin', 'namespace' => 'Admin'), function()
{
    ...
    Route::post('settings', array('before' => 'auth|csrf', 'uses' => 'Settings@store'));
     //Other added site navs
    Route::get('audios',         array('before' => 'auth', 'uses' => 'Dashboard@Audios'));
    Route::get('videos',         array('before' => 'auth', 'uses' => 'Dashboard@Videos'));
});
