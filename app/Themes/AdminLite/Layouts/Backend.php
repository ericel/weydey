...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= site_url(); ?>" class="logo">
      ...
      <span class="logo-mini"><img src='<?= theme_url('images/logo_h.png', 'Bootstrap'); ?>' alt='<?= Config::get('app.name', SITETITLE); ?>'></span>
      <!-- logo for regular state and mobile devices -->
      
      <span class="logo-lg"><img src='<?= theme_url('images/logo_h.png', 'Bootstrap'); ?>' alt='<?= Config::get('app.name', SITETITLE); ?>'></span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://www.weytindey.com/" target="_blank"><b>Weytindey <?= $version; ?> / Kernel <?= VERSION; ?></b></a> - </strong> All rights reserved.
  </footer>
...
Assets::js(array(
  ...
  'https://cdnjs.cloudflare.com/ajax/libs/Counter-Up/1.0.0/jquery.counterup.min.js',
    ...
    theme_url('js/main.js', 'AdminLite'),
));
